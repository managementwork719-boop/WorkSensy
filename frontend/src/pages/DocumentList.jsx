    ...
    return (
        <div className="p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white/70 backdrop-blur-xl p-6 rounded-3xl border border-slate-200/60 shadow-sm">
                ...
                <button
                    onClick={() => navigate(`/${type}s/create`)}
            ...
            {loading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {filteredDocs.map((doc) => (
                        <div 
                            key={doc._id} 
                            onClick={() => navigate(`/${type}s/edit/${doc._id}${doc.isFinalized ? '?download=true' : ''}`)}
                        ...
                        >
                           ...
                           <div className="flex items-center justify-between pt-4 border-t border-slate-100">
                               ...
                               <div className="flex gap-2" onClick={(e) => e.stopPropagation()}>
                                   ...
                                   {!doc.isFinalized ? (
                                       <button 
                                            onClick={() => navigate(`/${type}s/edit/${doc._id}`)}
                                       ...
                                       <button 
                                            onClick={() => navigate(`/${type}s/edit/${doc._id}?download=true`)}
